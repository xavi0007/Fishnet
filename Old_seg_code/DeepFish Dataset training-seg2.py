...
if __name__ == "__main__":
    ...
    # scheduler2 = lr.MultiStepLR(optimizer,milestones=[10,15],gamma=0.1, verbose = True)
    ...
    for epoch in range(exp_dict["max_epoch"]):  # loop over the dataset multiple times
    ...
    final_val = predict_acc(net.to(device), val_loader)
